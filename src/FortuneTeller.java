...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
    ...
    FortuneTeller() throws Exception {
   	 ...
   	 fortuneTellerImage = ImageIO.read(getClass().getResource("cystalball.jpg"));
    ...
    static void begin() {
    	...
    	JOptionPane.showMessageDialog(null, "Glare aculetely");
    }
    ...
    public void mousePressed(MouseEvent e) {
   	 ...
   	 int secretLocationX = 174;
   	 int secretLocationY = 144;
