...
public class Backpack {
	...
	public static void main(String[] args) {
		/* Your mission is to get to school but do to so you will need to get all of your supplies into your backpack */
		Backpack coolbackpack = new Backpack();
		Pencil pencil = new Pencil();
		Ruler ruler = new Ruler();
		Textbook textbook = new Textbook();
		coolbackpack.putInBackpack(pencil);
		coolbackpack.putInBackpack(ruler);
