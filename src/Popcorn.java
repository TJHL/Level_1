...
public class Popcorn {
	...
	public static void main(String[] args) {
		Popcorn bagged = new Popcorn("Buttered and Salted");
		Microwave burnitroon3000 =new Microwave();
		burnitroon3000.putInMicrowave(bagged);
		burnitroon3000.setTime(2);
		burnitroon3000.startMicrowave();
	}
