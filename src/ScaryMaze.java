...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("Very scare maze.png"));
...
//7. find a scary sound and put it in the "default package" where you put yourmaze picture. here are a lot of scary sounds: http://bit.ly/scary­sounds
...
showScaryImage("S.jpg");
	...
	public void run() {
		...
		JFrame frame = new JFrame("Toby's Scary Maze");
